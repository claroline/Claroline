...
$logLine = "Connecting to the database...";
file_put_contents($logFile, $logLine . "\n", FILE_APPEND);
...
$logLine = "Removing old operations.xml...";
file_put_contents($logFile, $logLine . "\n", FILE_APPEND);
...
$logLine = "Generating operations.xml...";
file_put_contents($logFile, $logLine . "\n", FILE_APPEND);
