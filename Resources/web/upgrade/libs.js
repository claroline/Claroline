...
var Translator = function () {
	this.translations = {
		'fr': {
			...
			'post_update': 'Cliquez sur exécuter pour lancer le script de mise à jour.',
		...
		'en': {
			...
			'replace_vendor_content': 'Please replace the vendors directory of your application.',
			'post_update_title': 'Upgrade execution',
			'post_update_content': 'Press execute to start the upgrade script',
