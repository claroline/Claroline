    ...
    angular
        ...
        .config([
            ...
            function PathEditorConfig($routeProvider) {
                $routeProvider
                    .when('/:stepId?', {
                        templateUrl: AngularApp.webDir + 'bundles/innovapath/angularjs/Step/Partial/edit.html',
    ...
    angular
        ...
        .config([
            ...
            function PathPlayerConfig($routeProvider) {
                ...
                $routeProvider
                    .when('/:stepId?', {
                        templateUrl: AngularApp.webDir + 'bundles/innovapath/angularjs/Step/Partial/show.html',
