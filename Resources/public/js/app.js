...
var portfolioApp = angular.module('portfolioApp', ['ngResource', 'ngSanitize', 'ngAnimate', 'ui.tinymce', 'ui.resourcePicker', 'ui.datepicker', 'ui.dateTimeInput', 'mgcrea.ngStrap.popover']);
