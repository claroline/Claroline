!function() {
    ...
    var q = 0, r = function() {
        ...
        var n = null, o = !1, p = [], q = {}, s = {}, u = {}, v = {}, w = {}, x = {}, y = !1, z = [], A = !1, B = null, C = this.Defaults.Scope, D = null, E = 1, F = function() {
            ...
            if (!jsPlumbAdapter.headless && !A) {
                ...
                if (h)
                    for (var j in h)
                        W({elId: h[j].id, offset: {left: i.o.left + h[j].offset.left, top: i.o.top + h[j].offset.top}, recalc: !1, timestamp: d});
            ...
            var d = t.extend({}, b);
            if (c && t.extend(d, c), d.source && (d.source.endpoint ? d.sourceEndpoint = d.source : d.source = e.getDOMElement(d.source)), d.target && (d.target.endpoint ? d.targetEndpoint = d.target : d.target = e.getDOMElement(d.target)), b.uuids && (d.sourceEndpoint = K(b.uuids[0]), d.targetEndpoint = K(b.uuids[1])), d.sourceEndpoint && d.sourceEndpoint.isFull())
                return a.log(e, "could not add connection; source endpoint is full"), void 0;
        ...
        var Z = [{el: "source", elId: "sourceId", epDefs: "sourceEndpointDefinitions"}, {el: "target", elId: "targetId", epDefs: "targetEndpointDefinitions"}], $ = function(a, b, c, d) {
        ...
        this.unregisterEndpoint = function(a) {
            ...
            if (0 !== arguments.length) {
                ...
                if (g)
                    (f || jsPlumbUtil.functionChain(!0, !1, [[g.endpoints[0], "isDetachAllowed", [g]], [g.endpoints[1], "isDetachAllowed", [g]], [g, "isDetachAllowed", [g]], [e, "checkCondition", ["beforeDetach", g]]])) && g.endpoints[0].detach(g, !1, !0, d);
                else {
                    var h = t.extend({}, c);
                    if (h.uuids)
        ...
        this.init = function() {
            ...
            if (d.compute && d.getOrientation)
                return d;
            if ("string" == typeof d)
                h = c(arguments[0], {elementId: f, jsPlumbInstance: e});
            else if (a.isArray(d))
                if (a.isArray(d[0]) || a.isString(d[0]))
                    2 == d.length && a.isObject(d[1]) ? a.isString(d[0]) ? (b = t.extend({elementId: f, jsPlumbInstance: e}, d[1]), h = c(d[0], b)) : (b = t.extend({elementId: f, jsPlumbInstance: e, anchors: d[0]}, d[1]), h = new t.DynamicAnchor(b)) : h = new t.DynamicAnchor({anchors: d, selector: null, elementId: f, jsPlumbInstance: g});
                else {
            ...
            for (var f = [], g = 0, h = b.length; h > g; g++)
                "string" == typeof b[g] ? f.push(t.Anchors[b[g]]({elementId: c, jsPlumbInstance: d})) : a.isArray(b[g]) && f.push(e.makeAnchor(b[g], c, d));
            return f
            ...
            var h = g.scope || e.Defaults.Scope, i = !(g.deleteEndpointsOnDetach === !1), l = g.maxConnections || -1, m = g.onMaxConnections, n = function(c) {
                ...
                var o = function() {
                    ...
                    if (!p.enabled || p.maxConnections > 0 && c >= p.maxConnections)
                        return m && m({element: d.el, connection: l}, a), !1;
                    if (o.anchor.locked = !1, k && this.setDragScope(h, k), null == l.suspendedEndpoint && !l.pending)
                        return!1;
                ...
                var w = function(a) {
                    ...
                    if (d = this.getId(this.getDOMElement(f)), c.enabled) {
                        ...
                        if (c.maxConnections >= 0 && o >= c.maxConnections)
                            return j && j({element: f, maxConnections: h}, a), !1;
        ...
        this.initDraggable = function() {
            if (!t && jsPlumb.isDragSupported(this.element)) {
                var d = {id: null, element: null}, e = null, f = !1, m = null, n = a(d, h), q = function() {
                    ...
                    if (jsPlumbAdapter.setPosition(d.element, s), this.parentAnchor && (this.anchor = h.makeAnchor(this.parentAnchor, this.elementId, h)), h.setAttribute(this.canvas, "dragId", d.id), h.setAttribute(this.canvas, "elId", this.elementId), this._jsPlumb.floatingEndpoint = c(this.getPaintStyle(), this.anchor, this.endpoint, this.canvas, d.element, h, l), this.canvas.style.visibility = "hidden", null == e)
                        this.anchor.locked = !0, this.setHover(!1, !1), e = k({sourceEndpoint: this, targetEndpoint: this._jsPlumb.floatingEndpoint, source: this.endpointWillMoveTo || this.element, target: d.element, anchors: [this.anchor, this._jsPlumb.floatingEndpoint.anchor], paintStyle: g.connectorStyle, hoverPaintStyle: g.connectorHoverStyle, connector: g.connector, overlays: g.connectorOverlays, type: this.connectionType, cssClass: this.connectorClass, hoverClass: this.connectorHoverClass}), e.pending = !0, e.addClass(h.draggingClass), this._jsPlumb.floatingEndpoint.addClass(h.draggingClass), h.fire("connectionDrag", e);
                    else {
                        f = !0, e.setHover(!1);
    ...
    jsPlumb.AnchorManager = function(a) {
        var b = {}, c = {}, d = {}, e = {}, f = {}, g = {HORIZONTAL: "horizontal", VERTICAL: "vertical", DIAGONAL: "diagonal", IDENTITY: "identity"}, h = {}, i = this, j = {}, k = a.jsPlumbInstance, l = {}, m = function(a, b, c, d, e, f) {
            if (a === b)
                return{orientation: g.IDENTITY, a: ["top", "top"]};
        ...
        this.updateOtherEndpoint = function(a, b, c, d) {
            ...
            if (!k.isSuspendDrawing()) {
                ...
                for (v = 0; v < i.length; v++)
                    0 === i[v].connections.length && i[v].anchor.isContinuous && (j[a] || (j[a] = {top: [], right: [], bottom: [], left: []}), u(j[a], -Math.PI / 2, 0, {endpoints: [i[v], i[v]], paint: function() {
        ...
        var v = function(a) {
            ...
            for (var b = a.faces || ["top", "right", "bottom", "left"], c = !(a.clockwise === !1), g = {}, h = {top: "bottom", right: "left", left: "right", bottom: "top"}, i = {top: "right", right: "bottom", left: "top", bottom: "left"}, j = {top: "left", right: "top", left: "bottom", bottom: "right"}, k = c ? i : j, l = c ? j : i, m = a.cssClass || "", n = 0; n < b.length; n++)
                g[b[n]] = !0;
    ...
    jsPlumb.DOMElementComponent = jsPlumbUtil.extend(jsPlumb.jsPlumbUIComponent, function() {
        this.mousemove = this.dblclick = this.click = this.mousedown = this.mouseup = function() {
            ...
            var b = (jsPlumb.Segments.AbstractSegment.apply(this, arguments), [{x: a.x1, y: a.y1}, {x: a.cp1x, y: a.cp1y}, {x: a.cp2x, y: a.cp2y}, {x: a.x2, y: a.y2}]), c = {minX: Math.min(a.x1, a.x2, a.cp1x, a.cp2x), minY: Math.min(a.y1, a.y2, a.cp1y, a.cp2y), maxX: Math.max(a.x1, a.x2, a.cp1x, a.cp2x), maxY: Math.max(a.y1, a.y2, a.cp1y, a.cp2y)};
            this.type = "Bezier";
        ...
        this.setSegments = function(a) {
            ...
            var k = a.startStubX + (a.endStubX - a.startStubX) * d, m = a.startStubY + (a.endStubY - a.startStubY) * d, n = {x: [0, 1], y: [1, 0]}, p = function() {
                return[a.startStubX, a.startStubY, a.endStubX, a.endStubY]
                    ...
                    return!l || 1 == g.so[t] && d > f || -1 == g.so[t] && f > d ? {x: [[d, m], [f, m]], y: [[k, d], [k, f]]}[b] : 1 == g.so[t] && f > d || -1 == g.so[t] && d > f ? {x: [[k, g.sy], [k, g.ty]], y: [[g.sx, m], [g.tx, m]]}[b] : void 0
    ...
    jsPlumbUtil.extend(w, jsPlumb.jsPlumbUIComponent, {cleanup: function() {
        ...
        var b = this, c = w.apply(this, [{cssClass: a._jsPlumb.connectorClass, originalArgs: arguments, pointerEventsSpec: "none", _jsPlumb: a._jsPlumb}]);
    ...
    var x = window.SvgEndpoint = function(a) {
        var b = w.apply(this, [{cssClass: a._jsPlumb.endpointClass, originalArgs: arguments, pointerEventsSpec: "all", useDivWrapper: !0, _jsPlumb: a._jsPlumb}]);
    ...
    var f = 1e3, g = function(a, b) {
        ...
        if (b.fillStyle) {
            ...
            e.filled = "false";
        if (b.dashstyle)
            null == c.strokeNode ? c.strokeNode = h("stroke", [0, 0, 0, 0], {dashstyle: b.dashstyle}, a, d) : c.strokeNode.dashstyle = b.dashstyle;
    ...
    var n = jsPlumb.ConnectorRenderers.vml = function(b) {
        ...
        this.paint = function(d) {
            if (null !== d) {
                ...
                for (var e = this.getSegments(), j = {path: ""}, k = [this.x, this.y, this.w, this.h], m = 0; m < e.length; m++)
    ...
    a.extend(jsPlumbInstance.prototype, {getDOMElement: function(a) {
            return null == a ? null : "string" == typeof a ? document.getElementById(a) : a.context || null != a.length ? a[0] : a
        }, getElementObject: b, removeElement: function(a) {
            b(a).remove()
            ...
            var d;
            if (b = b || 1, 1 == a.length)
                d = {left: a[0].pageX, top: a[0].pageY};
            else {
        ...
        }, dragEvents: {start: "start", stop: "stop", drag: "drag", step: "step", over: "over", out: "out", drop: "drop", complete: "complete"}, animEvents: {step: "step", complete: "complete"}, trigger: function(a, c, d) {
