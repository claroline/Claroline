        ...
        return {
          ...
          link: function(scope, element, attrs, controllersArr) {
            ...
            var dragStart = function(e) {
			  ...
			  if (config.keepDragContentOnScene){
				hiddenPlaceElm.html(scope.$element.html());
			  }			  
            ...
            var dragMove = function(e) {
			  ...
			  var eventTargetElm = angular.element(eventObj.target);
			  var eventTargetElmScope = eventTargetElm.scope();
			  if (dragElm) {
                e.preventDefault();
				...
				/*if(angular.isDefined(eventTargetElmScope)&&eventTargetElmScope!=null&&eventTargetElmScope.$type=="uiTreeNode"&&(eventTargetElm.parent().hasClass("tree-node-content"))){
					placeElm.css('display','none');
					console.log(eventTargetElm.parent());
				} else {
                ...
                if (pos.dirAx && pos.distAxX >= config.levelThreshold) {
                  ...
                  if (pos.distX > 0) {
                    ...
                    if (prev && !prev.collapsed
					  ...
					  //console.log(prev.depth());
                      //placeElm.css('margin-left', ((prev.depth()-1)*15)+'px');
            ...
            var dragEnd = function(e) {
			  ...
			  if (dragElm) {
                ...
                scope.$treeScope.$apply(function() {
                  scope.$callbacks.dragStop(dragInfo.eventArgs(elements, pos, e));
                });
                scope.$$apply = false;
                dragInfo = null;
