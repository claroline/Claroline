(function () {
  ...
  function MainController(websiteOptions, websiteTree, tinyMceConfig) {
    ...
    vm.bannerStyle = function () {
      return {
        height: vm.options.bannerHeight + 'px',
        'background-color': vm.options.bannerBgColor,
        'background-position': vm.options.bannerBgPosition,
        'background-repeat': vm.options.bannerBgRepeat,
    ...
    vm.menuHorizontalStyle = function () {
      if (vm.options.menuOrientation == 'horizontal') {
        return {
          'background-color': vm.options.menuBgColor,
          'color': vm.options.menuFontColor,
          'font-size': vm.options.menuFontSize + 'px',
          'font-family': vm.options.menuFontFamily
        }
      } else {
        return {};
      }
    ...
    vm.menuVerticalStyle = function () {
      if (vm.options.menuOrientation == 'vertical') {
        return {
          'min-height': vm.contentHeight + 'px',
          'width': vm.options.menuWidth + 'px',
          'background-color': vm.options.menuBgColor,
          'color': vm.options.menuFontColor,
          'font-size': vm.options.menuFontSize + 'px',
          'font-family': vm.options.menuFontFamily
    ...
    vm.websitePreviewStyle = function () {
      return {
        'background-color': vm.options.bgColor,
        'background-image': this.options.getImageStyleText('bgImage'),
        'background-position': vm.options.bgPosition,
        'background-repeat': vm.options.bgRepeat
      };
    };
    ...
    vm.footerStyle = function () {
      return {
        height: vm.options.footerHeight + 'px',
        'background-color': vm.options.footerBgColor,
        'background-position': vm.options.footerBgPosition,
        'background-repeat': vm.options.footerBgRepeat,
