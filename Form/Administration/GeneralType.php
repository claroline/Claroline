...
class GeneralType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('platform_init_date', 'date', array('input' => 'string', 'label' => 'platform_init_date', 'required' => false))
            ->add('platform_limit_date', 'date', array('input' => 'string', 'label' => 'platform_expiration_date', 'required' => false));
   }
