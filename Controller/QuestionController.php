...
class QuestionController extends Controller
{
    ...
    public function editAction($id, $exoID, $form = null)
    {
        ...
        if ( (count($question) > 0) || ($shareAllowEdit) ) {
            ...
            //todo remplacer switch dans les services avec methode du genre edit
            switch ($typeInter) {
                case "InteractionQCM":
