...
// the store to use
import {actions, reducer, selectors} from '#/main/app/overlays/alert/store'
// the component to connect
import {AlertOverlay as AlertOverlayComponent} from '#/main/app/overlays/alert/components/overlay'
