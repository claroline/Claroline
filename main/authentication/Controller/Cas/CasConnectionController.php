...
namespace Claroline\AuthenticationBundle\Controller\Cas;

use Claroline\AuthenticationBundle\Library\Configuration\Cas\CasServerConfigurationFactory;
use Claroline\AuthenticationBundle\Library\Sso\CasFactory;
...
class CasConnectionController extends Controller
{
     ...
     * @EXT\Template("ClarolineAuthenticationBundle:cas:connect\check_connexion.html.twig")
     *
     * @param Request $request
     *
     * @return \Symfony\Component\HttpFoundation\Response
     ...
     * @EXT\Template("ClarolineAuthenticationBundle:cas:connect\create_account.html.twig")
     *
     * @param Request $request
     *
     * @return array
     ...
     * @EXT\Template("ClarolineAuthenticationBundle:cas:connect\link_account.html.twig")
     *
     * @param Request $request
     *
     * @return array
