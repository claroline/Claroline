...
class LoadPathData extends AbstractFixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $path->setPath('{"name": "My Path Name","description": "This is the path description","steps": [{"name": "fesfeftttttttttttesfsefes","type": 1,"picture": null,"expanded": true,"instructions": "This is the step instructions. But I have to tip more word.","durationHours": "02","durationMinutes": "30","who": 1,"where": 1,"withTutor": false,"withComputer": true,"resourceId": null,"children": [{   "resourceId": null,        "name": "Step-3",        "type": "seq",        "expanded": true,        "instructions": "blabla",        "durationHours": null,        "durationMinutes": null,        "who": null,        "where": null,        "withTutor": false,        "withComputer": true,        "children": [],        "resources": [],        "excludedResources": [                    ]    },    {        "resourceId": null,        "name": "Step-34",        "type": "seq",        "expanded": true,        "instructions": "blabla",        "durationHours": null,        "durationMinutes": null,        "who": null,        "where": null,        "withTutor": false,        "withComputer": true,        "children": [],        "resources": [],        "excludedResources": [                 ]    }],"excludedResources": [],"resources": [    {        "resourceId": null,        "name": "Texte",        "stepId": 1,        "type": "document",        "subType": "text",        "isDigital": false,        "propagateToChildren": true,        "url": "www.google.fr"    },    {        "resourceId": null,        "name": "Indifferent",        "type": "tool",        "subType": "indifferent",        "isDigital": false,        "propagateToChildren": true,        "parentStep": "Parcours",        "isExcluded": false    }]}],"progression": {"global": "todo","skills": "todo","scenario": "todo","validation": "todo","planner": "todo"},"id": "137"}');
        $path->setName($name);
