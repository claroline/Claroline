    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            CREATE TABLE claro_log_workspace_widget_config (
                ...
                resource_copy SMALLINT NOT NULL, 
                resource_create SMALLINT NOT NULL, 
                resource_shortcut SMALLINT NOT NULL, 
                resource_read SMALLINT NOT NULL, 
                ws_tool_read SMALLINT NOT NULL, 
                resource_export SMALLINT NOT NULL, 
                resource_update SMALLINT NOT NULL, 
                resource_update_rename SMALLINT NOT NULL, 
                resource_child_update SMALLINT NOT NULL, 
                resource_delete SMALLINT NOT NULL, 
                resource_move SMALLINT NOT NULL, 
                ws_role_subscribe_user SMALLINT NOT NULL, 
                ws_role_subscribe_group SMALLINT NOT NULL, 
                ws_role_unsubscribe_user SMALLINT NOT NULL, 
                ws_role_unsubscribe_group SMALLINT NOT NULL, 
                ws_role_change_right SMALLINT NOT NULL, 
                ws_role_create SMALLINT NOT NULL, 
                ws_role_delete SMALLINT NOT NULL, 
                ws_role_update SMALLINT NOT NULL, 
                PRIMARY KEY(id)
            )
        ");
        $this->addSql("
