 ...
 *
 * Generation date: 2013/08/20 06:36:24
 */
class Version20130820183622 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            CREATE INDEX IDX_F45BA91298DDBDFD ON ujm_interaction_open_unit (interaction_open_id)
        ");
        $this->addSql("
            CREATE INDEX IDX_F45BA912F8BD700D ON ujm_interaction_open_unit (unit_id)
        ");
        $this->addSql("
        ...
        $this->addSql("
            ...
            REFERENCES ujm_unit (id) NOT DEFERRABLE INITIALLY IMMEDIATE
        ");
        $this->addSql("
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("
            ALTER TABLE ujm_interaction_open_unit 
            DROP CONSTRAINT FK_F45BA912F8BD700D
        ");
        $this->addSql("
            ALTER TABLE ujm_word_response 
        ...
        $this->addSql("
            ALTER TABLE ujm_interaction_open_unit 
            DROP CONSTRAINT FK_F45BA91298DDBDFD
        ");
        $this->addSql("
            ALTER TABLE ujm_word_response 
