 ...
 *
 * Generation date: 2015/02/06 12:15:10
 */
class Version20150206121509 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            ...
            ADD COLUMN personal_workspace_creation_enabled BOOLEAN NOT NULL
        ");
        $this->addSql("
        ...
        ");
        $this->addSql("
            INSERT INTO claro_directory (
                id, resourceNode_id, is_upload_destination
            ) 
            SELECT id, 
            resourceNode_id, 
            is_upload_destination 
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("
            INSERT INTO claro_directory (
                id, is_upload_destination, resourceNode_id
            ) 
            SELECT id, 
            is_upload_destination, 
            resourceNode_id 
