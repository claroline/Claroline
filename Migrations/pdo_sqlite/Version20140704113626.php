 ...
 *
 * Generation date: 2014/07/04 11:36:27
 */
class Version20140704113626 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            INSERT INTO claro_badge_rule (
                ...
                resultComparison, userType, resultMax, 
        ...
        $this->addSql("
            INSERT INTO claro_activity_rule (
                id, badge_id, resource_id, activity_parameters_id, 
