    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            INSERT INTO icap__dropzonebundle_drop (
                id, hidden_directory_id, user_id, 
                drop_zone_id, drop_date, reported, 
                finished, number, auto_closed_drop
            ) 
            SELECT id, 
            hidden_directory_id, 
            user_id, 
        ...
        $this->addSql("
            ...
            ADD COLUMN auto_close_opened_drops_when_time_is_up BOOLEAN DEFAULT '0' NOT NULL
        ");
        $this->addSql("
            ALTER TABLE icap__dropzonebundle_dropzone 
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("
            CREATE TABLE icap__dropzonebundle_drop (
                ...
                finished BOOLEAN NOT NULL, 
                number INTEGER NOT NULL, 
                auto_closed_drop BOOLEAN NOT NULL, 
                PRIMARY KEY(id), 
                CONSTRAINT FK_3AD19BA6A8C6E7BD FOREIGN KEY (drop_zone_id) 
                REFERENCES icap__dropzonebundle_dropzone (id) NOT DEFERRABLE INITIALLY IMMEDIATE, 
                CONSTRAINT FK_3AD19BA6A76ED395 FOREIGN KEY (user_id) 
