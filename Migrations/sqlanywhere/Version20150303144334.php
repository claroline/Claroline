...
class Version20150303144334 extends AbstractMigration
{
    ...
    {
        $this->addSql("
            DROP INDEX claro_cursusbundle_course_session_group.cursus_group_unique_course_session_group
        ");
        $this->addSql("
        ...
        ");
        $this->addSql("
            DROP INDEX claro_cursusbundle_cursus_group.cursus_group_unique_cursus_group
        ");
        $this->addSql("
            CREATE UNIQUE INDEX cursus_group_unique_cursus_group ON claro_cursusbundle_cursus_group (cursus_id, group_id, group_type)
        ");
        $this->addSql("
            DROP INDEX claro_cursusbundle_course_session_user.cursus_user_unique_course_session_user
        ");
        $this->addSql("
        ...
        ");
        $this->addSql("
            DROP INDEX claro_cursusbundle_cursus_user.cursus_user_unique_cursus_user
        ");
        $this->addSql("
