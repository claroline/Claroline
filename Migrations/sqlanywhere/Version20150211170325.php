...
class Version20150211170325 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            DROP INDEX claro_field_facet.IDX_F6C21DB2FC889F24
        ");
        $this->addSql("
            ALTER TABLE claro_field_facet RENAME facet_id TO panelFacet_id
        ");
        $this->addSql("
            ALTER TABLE claro_field_facet 
    ...
    public function down(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            DROP INDEX claro_field_facet.IDX_F6C21DB2E99038C0
        ");
        $this->addSql("
            ALTER TABLE claro_field_facet RENAME panelfacet_id TO facet_id
        ");
        $this->addSql("
            ALTER TABLE claro_field_facet 
