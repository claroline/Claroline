...
class Version20150331160852 extends AbstractMigration
{
    ...
    {
        $this->addSql("
            DROP INDEX claro_home_tab_config.home_tab_config_unique_home_tab_user
        ");
        $this->addSql("
            DROP INDEX claro_home_tab_config.home_tab_config_unique_home_tab_workspace
        ");
        $this->addSql("
    ...
    {
        $this->addSql("
            DROP INDEX claro_home_tab_config.home_tab_config_unique_home_tab_user_workspace_type
        ");
        $this->addSql("
