...
namespace Icap\BlogBundle\Migrations\sqlanywhere;
...
class Version20150106163709 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            ALTER TABLE icap__blog_widget_list_blog RENAME blog_id TO resourceNode_id
        ");
        $this->addSql("
    ...
    {
        $this->addSql("
            DROP INDEX icap__blog.IDX_FD75E6C4B87FAB32
        ");
        $this->addSql("
            DROP INDEX icap__blog_options.IDX_D1AAC984DAE07E97
        ");
        $this->addSql("
            ALTER TABLE icap__blog_widget_list_blog 
        ...
        ");
        $this->addSql("
            DROP INDEX icap__blog_widget_list_blog.IDX_294D4E02B87FAB32
        ");
        $this->addSql("
            ALTER TABLE icap__blog_widget_list_blog RENAME resourcenode_id TO blog_id
        ");
    }
}