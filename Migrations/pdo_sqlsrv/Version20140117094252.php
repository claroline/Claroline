...
namespace Icap\NotificationBundle\Migrations\pdo_sqlsrv;
 ...
 *
 * Generation date: 2014/01/17 09:42:53
 */
class Version20140117094252 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            CREATE TABLE icap__notification (
                ...
                user_id INT, 
                resource_id INT, 
                icon_key NVARCHAR(255) NOT NULL, 
