...
(function () {
    ...
    angular.module('ChatRoomModule').directive('chatRoomInit', [
        function () {
            return {
                restrict: 'E',
                replace: true,
                templateUrl: AngularApp.webDir + 'bundles/clarolinechat/js/ChatRoom/Directive/templates/chatRoomInit.html',
