...
export default class CursusRegistrationManagementCtrl {
    ...
    userPickerCallBack(datas) {
        ...
        this.$uibModal.open({
            template: require('../Partial/cursus_registration_sessions_modal.html'),
    ...
    registerGroups() {
        this.$uibModal.open({
            template: require('../Partial/cursus_groups_list_registration_modal.html'),
    ...
    unregisterGroup(cursusGroupId, groupName) {
        this.$uibModal.open({
            template: require('../Partial/cursus_group_unregistration_modal.html'),
    ...
    unregisterSelectedGroups() {
        ...
        this.$uibModal.open({
            template: require('../Partial/cursus_groups_unregistration_modal.html'),
    ...
    unregisterUser(cursusUserId, name) {
        this.$uibModal.open({
            template: require('../Partial/cursus_user_unregistration_modal.html'),
    ...
    unregisterSelectedUsers() {
        ...
        this.$uibModal.open({
            template: require('../Partial/cursus_users_unregistration_modal.html'),
