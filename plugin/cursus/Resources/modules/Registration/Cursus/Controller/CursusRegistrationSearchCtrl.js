...
export default class CursusRegistrationSearchCtrl {
        ...
        this.columns = [
            ...
            },
            {
                ...
                cellRenderer: scope => {
                    ...
                    let courseDescription = scope.$row['courseDescription']
                    let hasDescription = (description !== null && description !== '') ||
                        (courseDescription !== null && courseDescription !== '')

                    let descriptionElement = hasDescription ?
                        `
    ...
    showDescription(cursusId) {
        let infos = this.getCursusInfos(cursusId)
        ...
        if (infos !== null) {
            this.$uibModal.open({
                template: require('../Partial/cursus_description_modal.html'),
