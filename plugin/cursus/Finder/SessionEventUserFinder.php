...
class SessionEventUserFinder extends AbstractFinder
{
    public function getClass()
    {
        return SessionEventUser::class;
    }
        ...
        foreach ($searches as $filterName => $filterValue) {
            switch ($filterName) {
                ...
                case 'user.lastName':
                    ...
                    break;
                case 'status':
                    $qb->andWhere("obj.registrationStatus = :{$filterName}");
                    $qb->setParameter($filterName, $filterValue);
                    break;
                default:
