...
class SimpleTextQuestionAnswerRepository extends EntityRepository
{
    public function findSimpleTextAnswerByQuestionAnswer(
        QuestionAnswer $questionAnswer,
        $executeQuery = true
    ) {
        $dql = "
            SELECT stqa
            FROM Claroline\SurveyBundle\Entity\Answer\SimpleTextQuestionAnswer stqa
            WHERE stqa.questionAnswer = :questionAnswer
        ";
