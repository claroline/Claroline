...
const Framework = (props) =>
  <TreeData
    ...
    primaryAction={(row) => ({
      type: LINK_BUTTON,
      target: row.parent ?
        `${props.path}/frameworks/${row.parent.id}/competency/${row.id}` :
        `${props.path}/frameworks/${row.id}/competency/${row.id}`,
    ...
    actions={(rows) => [
      {
        ...
        target: rows[0].parent ?
          `${props.path}/frameworks/${rows[0].parent.id}/competency/${rows[0].id}` :
          `${props.path}/frameworks/${rows[0].id}/competency/${rows[0].id}`
      }, {
        type: LINK_BUTTON,
        ...
        scope: ['object'],
        target: `${props.path}/frameworks/${rows[0].id}/competency`
      }, {
        type: LINK_BUTTON,
        icon: 'fa fa-fw fa-plus',
        ...
        scope: ['object'],
        target: `${props.path}/frameworks/${rows[0].id}/ability`
      }, {
        type: LINK_BUTTON,
        ...
        displayed: 0 === rows[0].children.length,
        scope: ['object'],
        target: `${props.path}/frameworks/${rows[0].id}/ability_choice`
      }
    ]}
