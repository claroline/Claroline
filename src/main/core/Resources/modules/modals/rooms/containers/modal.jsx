...
import {reducer, selectors} from '#/main/core/modals/rooms/store'
import {RoomsModal as RoomsModalComponent} from '#/main/core/modals/rooms/components/modal'

const RoomsModal = withReducer(selectors.STORE_NAME, reducer)(
  connect(
    (state) => ({
