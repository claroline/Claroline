...
import {selectors as toolSelectors} from '#/main/core/tool/dashboard/store'
...
const EvaluationDashboardMetrics = () => {
  ...
  const hasSuccessCondition = useSelector(selectors.hasSuccessCondition)

  const [metricsData] = useFetch(selectors.STORE_NAME+'.metrics', ['apiv2_workspace_metrics', {id: workspace.id}])
