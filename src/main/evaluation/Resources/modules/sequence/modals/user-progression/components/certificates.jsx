...
import {getCertificateActions} from '#/main/evaluation/sequence/utils'
...
const UserProgressionCertificates = ({certificates}) => {
  ...
  return (
    <>
      <p className="text-body-secondary fs-sm">Retrouvez tous les certificats obtenus pour cette séquence.</p>
