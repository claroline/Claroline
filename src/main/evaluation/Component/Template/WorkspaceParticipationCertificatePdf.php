...
final class WorkspaceParticipationCertificatePdf extends PdfComponent
{
    ...
    public function getSystemTemplate(): TemplateInterface
    {
        return (new SystemTemplate())
            ->addTemplateContent(
                ...
                $this->twig->render('@ClarolineEvaluation/template/workspace_participation_certificate.en.pdf.twig')
            )
            ->addTemplateContent(
                'fr',
                'Certificat de participation à "%evaluated_content_name%"',
                $this->twig->render('@ClarolineEvaluation/template/workspace_participation_certificate.fr.pdf.twig')
            );
    }
}
