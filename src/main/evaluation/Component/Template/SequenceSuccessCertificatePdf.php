...
final class SequenceSuccessCertificatePdf extends PdfComponent
{
    ...
    public function getSystemTemplate(): TemplateInterface
    {
        return (new SystemTemplate())
            ->addTemplateContent(
                ...
                $this->twig->render('@ClarolineEvaluation/template/sequence_success_certificate.en.pdf.twig')
            )
            ->addTemplateContent(
                'fr',
                'Certificat de réussite à "%evaluated_content_name%"',
                $this->twig->render('@ClarolineEvaluation/template/sequence_success_certificate.fr.pdf.twig')
            );
    }
}
