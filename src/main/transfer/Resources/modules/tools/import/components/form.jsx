...
import {ImportSamples} from '#/main/transfer/tools/import/components/samples'
import {ImportExplanation} from '#/main/transfer/tools/import/components/explanation'
    ...
    const defaultFields = [
      {
        ...
        onChange: (value) => {
          ...
          props.history.push(`${this.props.path}/new/${entity}/${action}`)
        },
        required: true,
        options: {
          noEmpty: false,
