...
abstract class AbstractSecurityLog implements EventSubscriberInterface, ComponentInterface
{
    ...
    protected function log(string $message, User $target = null, User $doer = null): void
    {
        ...
        $this->logManager->logSecurity(static::getName(), $message, $doer, $target);
    }
}
