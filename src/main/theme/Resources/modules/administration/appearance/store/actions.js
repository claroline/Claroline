...
export const APPEARANCE_UPDATE_COLOR_CHART = 'APPEARANCE_UPDATE_COLOR_CHART'
...
actions.updateColorChart = makeActionCreator(APPEARANCE_UPDATE_COLOR_CHART, 'colorChart')
