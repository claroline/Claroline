...
class StubPlugin extends \Claroline\PluginBundle\AbstractType\ClarolineExtension
{
}
...
{
    /** @var Claroline\PluginBundle\Installer\Installer */
    private $installer;
    ...
    {
        $this->mockedLoader = $this->getMockBuilder('Claroline\PluginBundle\Installer\Loader')
            ->disableOriginalConstructor()
            ->getMock();
        $this->mockedValidator = $this->getMockBuilder('Claroline\PluginBundle\Installer\Validator\Validator')
            ->disableOriginalConstructor()
            ->getMock();
        $this->mockedMigrator = $this->getMockBuilder('Claroline\PluginBundle\Installer\Migrator')
            ->disableOriginalConstructor()
            ->getMock();
        $this->mockedRecorder = $this->getMockBuilder('Claroline\PluginBundle\Installer\Recorder\Recorder')
            ->disableOriginalConstructor()
            ->getMock();
    }
}