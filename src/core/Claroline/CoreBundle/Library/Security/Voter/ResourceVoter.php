...
class ResourceVoter implements VoterInterface
{
    ...
    public function vote(TokenInterface $token, $object, array $attributes)
    {
        ...
        if ($object instanceof ResourceCollection){
            ...
            if ($attributes[0] == 'MOVE'){
                ...
                $rightsCreation = $this->repository->getCreationRights($this->ut->getRoles($token), $object->getAttribute('parent'));
    ...
    {
        $rights = $this->em->getRepository('ClarolineCoreBundle:Rights\ResourceRights')->getRights($this->ut->getRoles($token), $resource);
