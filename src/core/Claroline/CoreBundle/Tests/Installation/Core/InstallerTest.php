...
namespace Claroline\CoreBundle\Installation\Core;
...
class InstallerTest extends TestCase
{
    ...
    /** @var Claroline\CoreBundle\Installation\BundleMigrator */
    ...
    {   
        $this->migratorMock = $this->getMockBuilder('Claroline\CoreBundle\Installation\BundleMigrator')
            ->disableOriginalConstructor()
            ->getMock();      
    }
}