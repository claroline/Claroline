...
namespace Claroline\CoreBundle\Installation\Plugin\Recorder;
...
class RecorderTest extends WebTestCase
{
    ...
    private function initMockObjects()
    {
        ...
        $this->mockedConfigWriter = $this->getMockBuilder('Claroline\CoreBundle\Installation\Plugin\Recorder\Writer\ConfigurationFileWriter')
            ...
            ->getMock();
        $this->mockedDbWriter = $this->getMockBuilder('Claroline\CoreBundle\Installation\Plugin\Recorder\Writer\DatabaseWriter')
            ->disableOriginalConstructor()
            ->getMock();
    }
}