...
class InstallerTest extends WebTestCase
{
    ...
    {
        $this->mockedLoader = $this->getMockBuilder('Claroline\CoreBundle\Installation\Plugin\Loader')
            ->disableOriginalConstructor()
            ->getMock();
        $this->mockedValidator = $this->getMockBuilder('Claroline\CoreBundle\Installation\Plugin\Validator\Validator')
            ->disableOriginalConstructor()
            ->getMock();
        $this->mockedMigrator = $this->getMockBuilder('Claroline\CoreBundle\Installation\Plugin\Migrator')
            ->disableOriginalConstructor()
            ->getMock();
        $this->mockedRecorder = $this->getMockBuilder('Claroline\CoreBundle\Installation\Plugin\Recorder\Recorder')
            ->disableOriginalConstructor()
            ->getMock();
    }
}