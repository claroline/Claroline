...
namespace Claroline\CoreBundle\Installer\Recorder;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class RecorderTest extends WebTestCase
{
    /** @var Claroline\CoreBundle\Installer\Recorder\Recorder */
    private $recorder;
    ...
    private function initMockObjects()
    {
        ...
        $this->mockedConfigWriter = $this->getMockBuilder('Claroline\CoreBundle\Installer\Recorder\Writer\ConfigurationFileWriter')
            ->disableOriginalConstructor()
            ->getMock();
        $this->mockedDbWriter = $this->getMockBuilder('Claroline\CoreBundle\Installer\Recorder\Writer\DatabaseWriter')
            ->disableOriginalConstructor()
            ->getMock();
    }
}