...
use Claroline\CoreBundle\Installer\Validator\Validator;

class ValidatorTest extends WebTestCase
{
    /** @var Claroline\CoreBundle\Installer\Validator\Validator */
    private $validator;
    ...
    {
        $checkers = array();
        $checkers['common'] = $this->getMockBuilder('Claroline\CoreBundle\Installer\Validator\Checker\CommonChecker')
            ->disableOriginalConstructor()
            ->getMock();
        $checkers['extension'] = $this->getMockBuilder('Claroline\CoreBundle\Installer\Validator\Checker\ExtensionChecker')
            ->disableOriginalConstructor()
            ->getMock();
        $checkers['tool'] = $this->getMockBuilder('Claroline\CoreBundle\Installer\Validator\Checker\ToolChecker')
            ->disableOriginalConstructor()
            ->getMock();
