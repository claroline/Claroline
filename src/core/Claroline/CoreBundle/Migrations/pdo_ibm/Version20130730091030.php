 ...
 *
 * Generation date: 2013/07/30 09:10:31
 */
class Version20130730091030 extends AbstractMigration
{
    ...
    {
        $this->addSql("
            ALTER TABLE claro_resource_type_custom_action ALTER resource_type_id resource_type_id INTEGER DEFAULT NULL
        ");
        $this->addSql("
    ...
    public function down(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            ALTER TABLE claro_resource_type_custom_action ALTER resource_type_id resource_type_id INTEGER NOT NULL
        ");
        $this->addSql("
            ALTER TABLE claro_resource_type_custom_action 
