...
class Version20130730091030 extends AbstractMigration
{
    ...
    {
        $this->addSql("
            ALTER TABLE claro_resource_type_custom_action ALTER COLUMN resource_type_id INT
        ");
        $this->addSql("
    ...
    public function down(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            ALTER TABLE claro_resource_type_custom_action ALTER COLUMN resource_type_id INT NOT NULL
        ");
        $this->addSql("
            ALTER TABLE claro_resource_type_custom_action 
