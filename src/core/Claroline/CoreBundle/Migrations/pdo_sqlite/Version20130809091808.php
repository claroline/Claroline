    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("
            INSERT INTO claro_resource_rights (
                id, role_id, resourceNode_id, can_delete, 
        ...
        $this->addSql("
            INSERT INTO claro_resource_activity (
                id, activity_id, resourceNode_id, 
                sequence_order
            ) 
            SELECT id, 
            activity_id, 
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("
            INSERT INTO claro_log (
                ...
                details, doer_type, doer_ip, tool_name, 
                child_type, child_action, resourceNode_id
            ) 
            SELECT id, 
            doer_id, 
            receiver_id, 
        ...
        $this->addSql("
            INSERT INTO claro_resource_activity (
                id, activity_id, sequence_order, resourceNode_id
            ) 
            SELECT id, 
            activity_id, 
            sequence_order, 
        ...
        $this->addSql("
            INSERT INTO claro_resource_rights (
                ...
                can_edit, can_copy, can_export, resourceNode_id
            ) 
            SELECT id, 
            role_id, 
            can_delete, 
