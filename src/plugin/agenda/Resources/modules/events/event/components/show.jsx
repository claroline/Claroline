...
import {selectors, reducer} from '#/plugin/agenda/events/event/store'
...
const EventShow = (props) => {
  ...
  const [event] = useFetch(selectors.STORE_NAME, ['apiv2_event_get', {id: props.id}])

  return (
    <ToolPage
      className="event-page"
      title={trans('event_name', {name: get(event, 'name', trans('loading'))}, 'agenda')}
