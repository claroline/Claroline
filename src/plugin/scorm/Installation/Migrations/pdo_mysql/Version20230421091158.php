...
class Version20230421091158 extends AbstractMigration
{
    ...
    {
        $this->addSql('
            ALTER TABLE claro_scorm_sco_tracking CHANGE details details LONGTEXT CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_unicode_ci` COMMENT "(DC2Type:json)"
        ');
    }
}
