...
const ProgressionRequirements = (props) => props.requirements ?
        ...
        actions={[
          {
            ...
            modal: [MODAL_RESOURCES, {
              ...
              current: props.root,
              root: props.root,
              filters: [{property: 'workspace', value: props.workspace.id, locked: true}],
...
ProgressionRequirements.propTypes = {
