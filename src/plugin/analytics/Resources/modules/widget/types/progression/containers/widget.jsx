...
import {actions, reducer, selectors} from '#/plugin/analytics/widget/types/progression/store'
import {ProgressionWidget as ProgressionWidgetComponent} from '#/plugin/analytics/widget/types/progression/components/widget'
