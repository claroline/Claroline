      ...
      actions={(rows) => [
        {
          ...
          displayed: getInfo(props.course, rows[0], 'registration.selfRegistration') && !getInfo(props.course, rows[0], 'registration.autoRegistration') && getInfo(props.course, rows[0], 'permissions.self_register') && !isRegistered(rows[0], props.registrations),
